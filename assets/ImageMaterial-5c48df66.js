import{ia as m,ib as P,ic as v,a_ as f,id as u,ie as y,ig as O,ih as A,ii as $,hH as r,ij as g,ik as S,il as c,im as C,aw as E,io as x,ip as _,ai as o,iq as n,ir as d,is as w,it as b,iu as N,iv as D,iw as M,ix as I,iy as R,iz as F,iA as L,iB as U,iC as B,iD as G,iE as H,iF as W,iG as z,iH as j,iI as q,hI as p,iJ as Q,iK as V,iL as k,iM as J}from"./index-080e108a.js";function K(a){const e=new m,{vertex:t,fragment:i}=e;return P(t,a),e.include(v,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
